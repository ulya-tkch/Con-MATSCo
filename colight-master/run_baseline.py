...
def parse_args_base():
    ...
    parser.add_argument("--memo", type=str, default='0509_evening_MaxPressure_6_6_bi')
    parser.add_argument("-all", action="store_true", default=False)
    parser.add_argument("--env", type=int, default=1)
    parser.add_argument("--gui", type=bool, default=0)
    parser.add_argument("--road_net", type=str, default='6_6')# 28_7
    parser.add_argument("--volume", type=str, default='300')#'newyork'
    parser.add_argument("--ratio", type=str, default='0.3_bi')#'0.3_uni', 'real_triple'
...
def main_base(memo, rall, road_net, env, gui, volume, ratio, model,count,lane):
...
if __name__ == "__main__":
    start=time.time()
    args = parse_args_base()
    # memo = "test"
    # args.g = True
    main_base(args.memo, args.all, args.road_net, args.env, args.gui, args.volume, args.ratio,args.model,args.count,args.lane)
    end=time.time()
    duration=end-start
